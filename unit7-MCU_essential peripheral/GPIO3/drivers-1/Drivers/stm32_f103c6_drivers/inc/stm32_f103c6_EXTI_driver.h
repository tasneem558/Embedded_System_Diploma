...
typedef struct
{
	...
	uint8_t                   IRQ_EN;          //Enable or disable the EXTI_IRQ(that will enable the IRQ MASK in EXTI and also on the NVIC interrupt
...
//EXTI1
#define EXTI0PA1     (EXTI_GPIO_Mapping_t){EXTI1,GPIO1,GPIO_PIN_1,EXTI1_IRQ}
#define EXTI0PB1     (EXTI_GPIO_Mapping_t){EXTI1,GPIOB,GPIO_PIN_1,EXTI1_IRQ}
